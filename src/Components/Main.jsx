  ...
  return (
    <Container>
      <ShareBox>
        <div>
          {props.user && props.user.photoURL ? (
            <img src={props.user.photoURL} alt="pic" />
          ) : (
        ...
        <div>
          ...
          <button>
            <img src="/images/video-icon.svg" alt="pic" />
            <span>Video</span>
          </button>
          <button>
            <img src="/images/event-icon.svg" alt="pic" />
            <span>Event</span>
          </button>
          <button>
            <img src="/images/article-icon.svg" alt="pic" />
      ...
      {props.articles.length === 0 ? (
        ...
        <Content>
          {props.loading && <img src="images/loader.svg" alt="loader" />}
          {props.articles.length > 0 &&
            props.articles.map((article, index) => (
              <Article key={index}>
                <SharedActor>
                  <a>
                    <img src={article.actor.image} alt="pic" />
                    <div>
                  ...
                  <button type="button">
                    <img src="/images/ellipsis.svg" alt="3 dots" />
                  </button>
                </SharedActor>
                ...
                <SharedImg>
                  <a>
                    {!article.shareImg && article.video ? (
                      ...
                      article.shareImg && (
                        <img src={article.shareImg} alt="pic" />
                      )
                    )}
                  </a>
                </SharedImg>
